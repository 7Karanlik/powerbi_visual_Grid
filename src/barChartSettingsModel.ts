...
class HeaderSettingsCard extends Card {
    showHeader = new ToggleSwitch({
        name: "showHeader",
    ...
    displayName: string = "Header Settings";

    slices: Slice[] = [this.showHeader];
}
...
export class BarChartSettingsModel extends Model {
    ...
    cards: Card[] = [this.enableAxis, this.colorSelector, this.generalView, this.averageLine, this.headerSettings, this.directEditSettings];
